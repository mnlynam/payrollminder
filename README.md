...
| `SLACK_ID_MIKE` | Slack member ID for Mike |
| `SLACK_ID_JANICE` | Slack member ID for Janice |
...
```
├── .clasp.json          # clasp project config (points to your Apps Script project)
...
Proprietary — © 2025 The Music Place
